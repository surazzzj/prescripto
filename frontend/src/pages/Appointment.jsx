...
const Appointment = () => {
    ...
    // ✅ Optimized doctor lookup (no extra state, no re-renders)
    ...
    return docInfo ? (
        <div>
            ...
            {/* 🔹 Lazy loaded Related Doctors */}
            <Suspense fallback={<p className="text-center mt-10 text-gray-500">Loading related doctors...</p>}>
                <RelatedDoctors speciality={docInfo.speciality} docId={docId} />
            </Suspense>
